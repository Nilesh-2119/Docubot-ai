...
export default function Sidebar({
    ...
    return (
        <aside
            className={`fixed left-0 top-0 h-full bg-dark-900 border-r border-dark-800 
        ...
        >
            ...
            <div className="px-3 pt-4">
                <button
                    ...
                    className={`sidebar-item w-full ${!activeBotId ? 'active' : ''}`}
                >
                            ...
                            {editingBot === bot.id && sidebarOpen ? (
                               ...
                               focus:outline-none focus:ring-1 focus:ring-brand-500"
                                ...
                                <button
                                    ...
                                    className={`sidebar-item w-full ${activeBotId === bot.id ? 'active' : ''}`}
                                >
                                    ...
                                    {sidebarOpen && (
                                        <>
                                            ...
                                            <button
                                                ...
                                                className="p-1 rounded opacity-0 group-hover:opacity-100 text-dark-500 hover:text-dark-300 transition-all"
                                            >
